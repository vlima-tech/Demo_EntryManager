...
public class LedgerReadRepository : BaseReadRepository<LedgerModel, long>, ILedgerReadRepository
{
    public LedgerReadRepository(AccrualContext context, IServiceBus serviceBus) 
        : base(context, serviceBus, Collections.LEDGER)
    {
    }
}