...
public class TransactionRepository : BaseRepository<TransactionModel, Guid>, ITransactionRepository
{
    public TransactionRepository(AccrualContext context, IServiceBus serviceBus, ITransactionReadRepository readRepository) 
