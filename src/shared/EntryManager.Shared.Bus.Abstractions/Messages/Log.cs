...
public class Log : Notification
{
    ...
    public Log(string message, ExecutionMode executionMode, [CallerMemberName] string sourceMethod = "",
    ...
    /// <param name="sourceLineNumber">Automatically captured at runtime. Do not set manually.</param>
    /// <param name="sourceFileName">Automatically captured at runtime. Do not set manually.</param>
    public Log(string code, string message, ExecutionMode executionMode, [CallerMemberName] string sourceMethod = "",
        [CallerLineNumber] int sourceLineNumber = 0, [CallerFilePath] string sourceFileName = "") 
    ...
    /// <param name="sourceLineNumber">Automatically captured at runtime. Do not set manually.</param>
    /// <param name="sourceFileName">Automatically captured at runtime. Do not set manually.</param>
    public Log(string code, string message, [CallerMemberName] string sourceMethod = "",
        [CallerLineNumber] int sourceLineNumber = 0, [CallerFilePath] string sourceFileName = "") 
